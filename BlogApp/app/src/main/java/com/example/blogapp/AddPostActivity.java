...
public class AddPostActivity extends AppCompatActivity {
    ...
    private EditText title_blog, description_blog;
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(title)) {
                    title_blog.setError("Başlık gerekli!");
                } else if (TextUtils.isEmpty(description)) {
                    description_blog.setError("Tanım gerekli!");
                } else {
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                pd.dismiss();
                                                Toast.makeText(AddPostActivity.this, "Post yüklendi", Toast.LENGTH_SHORT).show();
                                                title_blog.setText("");
    ...
    private void imagePickDialog() {
        ...
        builder.setTitle("Buradan fotoğraf seçiniz");
    ...
    private void cameraPick() {
        ...
        Intent intent = new Intent(MediaStore.EXTRA_OUTPUT, image_uri);
